                ...
                if (!this._div) {
                    ...
                    var template = [
                        ...
                        '<div class="BMapLib_bubble_center">',
                            ...
                            '<div class="BMapLib_nav" id="BMapLib_nav' + this.guid + '">',
                                ...
                                '<ul class="BMapLib_nav_tab_content">', //tab内容
                                    '<li id="BMapLib_searchBox' + this.guid + '" style="display:none">',
                                    ...
                                    '<li id="BMapLib_transBox' + this.guid + '" style="display:none">',
                                        '<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>',
                                            '<tr><td width="30" style="padding-left:8px; display:none;"><div id="BMapLib_stationText' + this.guid + '">起点</div></td><td style="padding-left:8px;"><input id="BMapLib_trans_text' + this.guid + '" class="BMapLib_trans_text" type="text" maxlength="100" autocomplete="off" placeholder="起点"></td><td width="106" style="padding-left:7px;"><input id="BMapLib_search_bus_btn' + this.guid + '" type="button" value="去这里" class="iw_bt BMapLib_search_bus_btn0 yh" style="margin-right:5px;"><input id="BMapLib_search_drive_btn' + this.guid + '" type="button" class="iw_bt BMapLib_search_drive_btn0 yh" value="驾车"></td></tr>',
                                        '</table>',
                                    '</li>',
                                '</ul>',
                            '</div>',
                        ...
                        '<div class="BMapLib_bubble_bottom" style="display:block;">',
                          '<a class="send-tel" onclick="openTel('+ "'" + this._opts.mkmsg + "',"  + 'this' + ')" href="javascript:void(0);">发送地址到手机</a>',
                        '</div>',
