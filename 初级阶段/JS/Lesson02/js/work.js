...
if(())
    ...
    switch(month)   //控制月的天数
    {
        case 12:{numberTime += 30};
        case 11:{numberTime += 31};
        case 10:{numberTime += 30};
        case 9:{numberTime += 31};
        case 8:{numberTime += 31};
        case 7:{numberTime += 30};
        case 6:{numberTime += 31};
        case 5:{numberTime += 30};
        case 4:{numberTime += 31};
        case 3:{numberTime += 28};
        case 2:{numberTime += 31};
        case 1:{numberTime += 0};
    }
    numberTime += days;
